...
metaDataFiles = ('/users/modellers/pica/Work/data/NSTD/shelf_stations_latlong_sql.csv',\
                 ...
                 '/users/modellers/pica/Work/data/SHOM/shelf_stations_sql.csv')
...
for file in metaDataFiles:
    ...
    if 'NSTD' in file:
        ...
        originator = 'NTSLF'
        originatorLong = 'National Tide and Sea Level Facility Data'
    elif 'NTSLF/BPR' in file:
        originator = 'BPR'
        originatorLong = 'Historical Bottom Pressure Sensor Recorder Data'
    elif 'SHOM' in file:
        originator = 'SHOM'
        originatorLong = 'Service Hydrographique et Oceanographique de la Marine Data'
    else:
