...
outfile=./images/tracklines_diff_2005.ps
...
plot() {
   ...
   grdimage $area $proj -Bg1000 -Cdiff.cpt ./grids/area473_07-05.grd -O -K \
      >> $outfile
   gmtset D_FORMAT %g
   psscale -D23.2/6/5/0.5 -B0.5 -Cdiff.cpt -O -K >> $outfile
   for line in ./tracklines/2005/*.pfl; do
      psxy $area $proj -O -K -B0 -Sc0.025 -G0/0/0 -W3/0/0/0 $line >> $outfile
   done
