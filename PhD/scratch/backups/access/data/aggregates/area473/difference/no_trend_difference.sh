...
set outfile_2003=./images/area473_2003_no_trend.ps
set outfile_2005=./images/area473_2005_no_trend.ps
set outfile_2006=./images/area473_2006_no_trend.ps
set diff_06_03=./images/diff_06_03_no_trend.ps
set diff_05_06=./images/diff_05_06_no_trend.ps
set diff_03_05=./images/diff_03_05_no_trend.ps
...
# 2003
#cat $infile_03 | tr "," " " | blockmean -I2.5 $area > ./raw_data/area473_2003.xyz.bmd
...
# just have the regional-scale bathy left - this time without returning the
# trend in the data (-L)
grdfft area473_2003_interp.grd -Garea473_2003_interp_fft_no_trend.grd -F-/-/800/70
grdfft area473_2005_interp.grd -Garea473_2005_interp_fft_no_trend.grd -F-/-/800/70
grdfft area473_2006_interp.grd -Garea473_2006_interp_fft_no_trend.grd -F-/-/800/70

# recreate the illumination based on the smoothed data
grdgradient area473_2003_interp_fft_no_trend.grd -A250 -Nt0.7 -Garea473_2003_grad.grd
grdgradient area473_2005_interp_fft_no_trend.grd -A250 -Nt0.7 -Garea473_2005_grad.grd
grdgradient area473_2006_interp_fft_no_trend.grd -A250 -Nt0.7 -Garea473_2006_grad.grd

# remask the areas
grdmath area473_2003_interp_fft_no_trend.grd area473_2006_mask.grd MUL = \
   area473_2003_fft.grd
grdmath area473_2005_interp_fft_no_trend.grd area473_2006_mask.grd MUL = \
   area473_2005_fft.grd
grdmath area473_2006_interp_fft_no_trend.grd area473_2006_mask.grd MUL = \
...
grd2cpt -Cwysiwyg $area -Z area473_2003_fft.grd > .bathy_03.cpt
# 2005
#makecpt -Cwysiwyg -T38/48/1 -I -Z > .bathy_05.cpt
grd2cpt -Cwysiwyg $area -Z area473_2005_fft.grd > .bathy_05.cpt
# 2006
#makecpt -Cwysiwyg -T38/48/1 -I -Z > .bathy_06.cpt
grd2cpt -Cwysiwyg $area -Z area473_2006_fft.grd > .bathy_06.cpt
# difference
...
2006
# diff_06_03
psscale -B0.5 -C.diff_06_03.cpt -D28/10/3/0.4 -O -K >> $diff_06_03
pstext $page $a4 -O << DIFF_06_03 >> $diff_06_03
27.4 12 12 0 0 1 Difference (m)
DIFF_06_03
# diff_05_06
psscale -B0.5 -C.diff_05_06.cpt -D28/10/3/0.4 -O -K >> $diff_05_06
pstext $page $a4 -O << DIFF_05_06 >> $diff_05_06
27.4 12 12 0 0 1 Difference (m)
DIFF_05_06
# diff_03_05
psscale -B0.5 -C.diff_03_05.cpt -D28/10/3/0.4 -O -K >> $diff_03_05
