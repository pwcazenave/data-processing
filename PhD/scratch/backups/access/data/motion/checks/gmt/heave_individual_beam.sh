...
# i/o
set infile=../swaths_heave.xyz
set outfile=./images/heave_beam_plot.ps
...
psxy $area $proj -O -K -Ba10f5g10:"Ping":/a5f2.5g2.5:"Depth (m)"::."Beam 65 Depth with Distance Along Track":WeSn single_beam.xy2 -Sc0.2 -W1/0/0/0 -C.beam.cpt >> $outfile
