...
segyread tape=../suimage/line109.sgy verbose=1 vblock=500 endian=0 | segyclean | supsimage height=9.0 width=4.5 style=normal f1num=-1 d1num=100.0 n1tic=0 f2num=100000 d2num=100000.0 n2tic=0 brgb=0,0,0 grgb=1.0,1.0,1.0 wrgb=1.0,1.0,1.0 x1beg=4 x1end=7.5 perc=99.2 > section_109.ps
...
# plot the picks
#psbasemap -R150551/172480/4000/7500 -JX9/-4.5 -B0/0NW -O -K >> overlay_109.ps
