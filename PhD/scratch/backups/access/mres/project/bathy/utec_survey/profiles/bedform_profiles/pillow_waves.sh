...
set outfile=../../images/profiles/pillow_waves.ps
set profile=profile_pillow_waves.trk

# use project to create profile coordinates
project -C581000/93500 -E581800/93900 -G2 -N > $profile
...
# plot the profiles
psbasemap $plot_area $plot_proj -Ba200f100g100:"Distance along line (m)":/a2f1g1WeSn:"Depth (m) CD"::."Depth Profile Across Large 3-D Dunes": -X-0.5 -Y-13 -O -K >> $outfile
...
grdtrack $profile -G../../subsets/pillow_waves/grids/utec_mask.grd -V > `basename $profile .trk`.pfl
