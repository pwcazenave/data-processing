...
set outfile=../../images/profiles/bank_slope_parallel.ps
set profile=profile_bank_slope_parallel.trk

# use project to create profile coordinates
project -C582000/92400 -E585000/94950 -G2 -N > $profile
...
# plot the profiles
psbasemap $plot_area $plot_proj -Ba500f500g100:"Distance along line (m)":/a2f1g1WeSn:"Depth (m) CD"::."Profile Along the Base of the Bank Slope": -X-0.5 -Y-13 -O -K >> $outfile
