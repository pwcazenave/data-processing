...
set proj=-JX15/11
set outfile=subbottom_lines.ps
...
awk '{print $1, $2, ($5/660)}' tracklines.txt | awk '{printf "%7.2f %7.2f 28 %8s\n", $1, $2, $3}' | psxy $proj $area -H9 -W1/255/255/255 -Sv0/0/0 -O >> $outfile
awk '{print $1, $2, ($5/660)}' subbottomlines.txt | awk '{printf "%7.2f %7.2f 28 %8s\n", $1, $2, $3}' | psxy $proj $area -H9 -W1/0/0/255 -Sv0/0/0 -O -K >> $outfile
