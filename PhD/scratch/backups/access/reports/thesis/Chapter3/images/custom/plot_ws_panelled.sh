...
gres=200
ingrd=./grids/ws_1m_blockmean_5m.grd
...
plots(){
	...
	# Asymmetry
	psbasemap $area $proj -Ba8000f4000:"Eastings":/a4000f2000:"Northings":weSn -X4.5 -Y-0.3 -O -K >> $outfile
	...
	# Wavelength
	psbasemap $area $proj -Ba8000f4000:"Eastings":/a4000f2000:"Northings":Wesn -X-20.2 -Y8.8 -O -K >> $outfile
