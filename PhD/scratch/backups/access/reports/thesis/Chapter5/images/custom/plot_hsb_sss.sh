...
#proj=-Jm32
outfile=./images/hsb_sss.ps
cpt=./cpts/hsb.cpt
bkscpt=./cpts/hsb_sss.cpt
szgrd=./grids/seazone.grd
cmapgrd=./grids/cmap_bathy.grd
rma2005=$HOME/mres/project/sidescan/hsb_1m_latlong.grd
...
makecpt -T77/192/1 -Cgray > $bkscpt
...
#    \rm -f ${rma2005%.*}_surface.grd ${rma2005%.*}_mask.grd
    awk '{if ($3!-0) print $0}' ${rma2005%.*}.xyz | \
