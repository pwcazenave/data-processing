...
outfile=./images/hsb_group11_Mvar_currents.ps

# Plot extents
area11=-R1976-03-18T00:00:00/1976-03-22T00:00:00/0/3.5
...
makePanels(){
    ...
    psbasemap $area11 $proj -Ba2Df6Hg12H/a1f0.2:"ms@+-1@+":WeSn -O -K -X2.2c -Y1.1c -P >> $outfile
    plotData $area11 $area11dir $xOff $yOff ${group11speed[2]} ${group11dir[2]} calibgroup11_HMvar_SM32_d50_var_microns_points.csv ${group11obs[2]}
    # Row 4 (group 11, site 3)
    psbasemap $area11 $proj -Ba2Df6Hg12H/a1f0.2:"ms@+-1@+":WeSn -O -K -X-${xOff}c -Y${yOff}c -P >> $outfile
    plotData $area11 $area11dir $xOff $yOff ${group11speed[0]} ${group11dir[0]} calibgroup11_HMvar_SM32_d50_var_microns_points.csv ${group11obs[0]}
    # Row 3 (group 11, site 11)
    psbasemap $area11 $proj -Ba2Df6Hg12H/a1f0.2:"ms@+-1@+":WeSn -O -K -X-${xOff}c -Y${yOff}c -P >> $outfile
    plotData $area11 $area11dir $xOff $yOff ${group11speed[4]} ${group11dir[4]} calibgroup11_HMvar_SM32_d50_var_microns_points.csv ${group11obs[4]}
    # Row 2 (group 11, site 9)
    psbasemap $area11 $proj -Ba2Df6Hg12H/a1f0.2:"ms@+-1@+":WeSn -O -K -X-${xOff}c -Y${yOff}c -P >> $outfile
    plotData $area11 $area11dir $xOff $yOff ${group11speed[3]} ${group11dir[3]} calibgroup11_HMvar_SM32_d50_var_microns_points.csv ${group11obs[3]}
    # Row 1 (group 11, site 5)
    psbasemap $area11 $proj -Ba2Df6Hg12H/a1f0.2:"ms@+-1@+":WeSn -O -K -X-${xOff}c -Y${yOff}c -P >> $outfile
    plotData $area11 $area11dir $xOff $yOff ${group11speed[1]} ${group11dir[1]} calibgroup11_HMvar_SM32_d50_var_microns_points.csv ${group11obs[1]}
