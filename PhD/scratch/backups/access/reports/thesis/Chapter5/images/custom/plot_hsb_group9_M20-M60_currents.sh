...
version=v5
rmsSpeed=./raw_data/combo_${version}_M20-M60_calibgroup9_currents_rms_speed_results.csv
rmsDir=./raw_data/combo_${version}_M20-M60_calibgroup9_currents_rms_direction_results.csv
lagsSpeed=./raw_data/combo_${version}_M20-M60_calibgroup9_currents_phase_speed_results.csv
lagsDir=./raw_data/combo_${version}_M20-M60_calibgroup9_currents_phase_direction_results.csv
