...
infile=../../../../../modelling/data/sediment_distribution/round_8_palaeo/ice-5g/rms_calibration/combo_v1_seds.mesh
area=-R-17/17/43/67
proj=-Jm0.55c
...
#    makecpt -T0/5/0.1 -Crainbow -Z > ./cpts/$base.cpt
    ...
    psscale -D9.3/23.4/6/0.4h -Ba5f1:"Grain size (mm)": -O -K -C./cpts/$base.cpt >> $outfile
