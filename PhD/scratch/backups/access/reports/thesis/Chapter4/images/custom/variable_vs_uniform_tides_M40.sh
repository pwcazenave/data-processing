...
# Script to plot the difference between the variable and M40 uniform
# Manning's models.
...
tidesHeight=(./raw_data/combo_v2_2003-01-28_NTSLF-SHOM-NHS_tides_M-1-M60_uni_var_diff_results.csv)
tidesOffshore=(./raw_data/calibgroup101_north_sea_points_M-1-M60_uni_var_diff_results.csv)
