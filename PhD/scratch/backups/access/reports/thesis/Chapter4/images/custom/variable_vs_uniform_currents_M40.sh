...
currentsSpeed=(./raw_data/combo_v2_M-1-M60_calibgroup?_speed_uni_var_diff_results.csv)
currentsDir=(./raw_data/combo_v2_M-1-M60_calibgroup?_dir_uni_var_diff_results.csv)
