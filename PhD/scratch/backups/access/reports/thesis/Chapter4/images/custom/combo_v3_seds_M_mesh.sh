...
infile=/media/z/modelling/data/sediment_distribution/round_8_palaeo/rms_calibration/combo_v3_seds_M.mesh
area=-R-17/17/43/67
proj=-Jm0.55c
...
plotMap(){
    ...
    makecpt -T20/100/1 -Crainbow -Z > ./cpts/$base.cpt
