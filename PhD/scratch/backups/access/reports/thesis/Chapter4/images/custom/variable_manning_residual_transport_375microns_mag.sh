...
gmtset BASEMAP_TYPE=plain PLOT_DEGREE_FORMAT=F ANNOT_FONT_SIZE=10 LABEL_FONT_SIZE=14 COLOR_NAN=white
...
DOMAIN
    ...
    psscale -D8.5/23.4/13/0.4h -Ba${scaleInt}f${scaleIntSub}:"${varLabel}": -Q -O -K -C./cpts/${base}_mag.cpt >> $outfile
