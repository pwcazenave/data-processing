...
#rmsSpeed=./raw_data/combo_v1_M-1-M60_calibgroup1_currents_rms_speed_results.csv
#rmsDir=./raw_data/combo_v1_M-1-M60_calibgroup1_currents_rms_direction_results.csv
#lagsSpeed=./raw_data/combo_v1_M-1-M60_calibgroup1_currents_phase_speed_results.csv
#lagsDir=./raw_data/combo_v1_M-1-M60_calibgroup1_currents_phase_direction_results.csv
rmsSpeed=./raw_data/combo_v2_M-1-M60_calibgroup1_currents_rms_speed_results.csv
rmsDir=./raw_data/combo_v2_M-1-M60_calibgroup1_currents_rms_direction_results.csv
lagsSpeed=./raw_data/combo_v2_M-1-M60_calibgroup1_currents_phase_speed_results.csv
lagsDir=./raw_data/combo_v2_M-1-M60_calibgroup1_currents_phase_direction_results.csv
    ...
    while read line; do
        if echo $line | grep -v NaN > /dev/null; then
            ...
            echo ${startX} ${data[2]} ${data[2]} | \
                psxy $narea $nproj -Sb0.6 -Gblack -W0.5,gray -O -K >> $outfile
#            # 20
#            echo ${startX} ${data[3]} ${data[3]} | \
#                psxy $narea $nproj -D-0.21/0 -Sb0.07 -G200/200/200 -W0.5,gray -O -K >> $outfile
#            # 25
#            echo ${startX} ${data[4]} ${data[4]} | \
#                psxy $narea $nproj -D-0.14/0 -Sb0.07 -G175/175/175 -W0.5,gray -O -K >> $outfile
#            # 32
#            echo ${startX} ${data[5]} ${data[5]} | \
#                psxy $narea $nproj -D-0.07/0 -Sb0.07 -G150/150/150 -O -K >> $outfile
#            # 35
#            echo ${startX} ${data[6]} ${data[6]} | \
#                psxy $narea $nproj -D0/0 -Sb0.07 -G125/125/125 -O -K >> $outfile
#            # 40
#            echo ${startX} ${data[7]} ${data[7]} | \
#                psxy $narea $nproj -D0.07/0 -Sb0.07 -G100/100/100 -O -K >> $outfile
#            # 45
#            echo ${startX} ${data[8]} ${data[8]} | \
#                psxy $narea $nproj -D0.14/0 -Sb0.07 -G75/75/75 -O -K >> $outfile
#            # 50
#            echo ${startX} ${data[9]} ${data[9]} | \
#                psxy $narea $nproj -D0.21/0 -Sb0.07 -G50/50/50 -O -K >> $outfile
#            # 55
#            echo ${startX} ${data[10]} ${data[10]} | \
#                psxy $narea $nproj -D0.28/0 -Sb0.07 -G25/25/25 -O -K >> $outfile
#            # 60
