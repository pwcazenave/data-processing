...
baseDir=./raw_data/
infile=palaeo_shear_stress_0-8k.csv
area=-R-12/10/47/61
proj=-Jm0.24c
...
base=palaeo_shear_stress_panels
...
#    grd2cpt ./grids/$inmesh.grd -L-2000/0 -Crainbow -Z > ./cpts/$inmesh.cpt
    makecpt -T0/2/0.2 -Cwysiwyg -Z --COLOR_FOREGROUND=red > ./cpts/${inmesh}_${currYr}.cpt
...
psscale -D-0.5/16.75/4/0.3 -Ba0.5f0.1:"Bed shear stress (N m@+-2@+)": -O -K -C./cpts/${inmesh}_${currYr}.cpt >> $outfile
