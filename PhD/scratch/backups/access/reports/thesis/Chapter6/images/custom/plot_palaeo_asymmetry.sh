...
baseDir=./raw_data/
infile=palaeo_asymmetry_0-8k.csv
...
base=palaeo_residual_transport_asymmetry_bed_panels
...
#    grd2cpt ./grids/$inmesh.grd -L-2000/0 -Crainbow -Z > ./cpts/$inmesh.cpt
    makecpt -T0.5/1/0.05 -Crainbow -Z > ./cpts/${inmesh}_${currYr}.cpt
...
psscale -D-0.5/16.75/4/0.3 -Ba0.1f0.02:"Transport asymmetry": -O -K -C./cpts/${inmesh}_${currYr}.cpt >> $outfile
