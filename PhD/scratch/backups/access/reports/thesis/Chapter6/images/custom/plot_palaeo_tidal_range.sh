...
baseDir=./raw_data/
infile=palaeo_tidal_range_0-8k.csv
area=-R-12/10/47/61
proj=-Jm0.24c
...
base=palaeo_tidal_range_panels
...
#    grd2cpt ./grids/$inmesh.grd -L-2000/0 -Crainbow -Z > ./cpts/$inmesh.cpt
    makecpt -T0/11/0.2 -Crainbow -Z > ./cpts/${inmesh}_${currYr}.cpt
...
psscale -D-0.5/16.75/4/0.3 -Ba2f0.5:"Tidal range (m)": -O -K -C./cpts/${inmesh}_${currYr}.cpt >> $outfile
