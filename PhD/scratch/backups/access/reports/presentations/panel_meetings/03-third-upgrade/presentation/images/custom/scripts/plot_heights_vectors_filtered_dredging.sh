...
outfile=./images/$(basename ${infile%.*}_heights_vectors_filtered_dredging.ps)
...
# add in the vectors
awk -F, '{if ($3>2 && $4>150 && $4<170) print $1,$2,$4,0.5*(log($3)/log(10))}' $infile | \
...
awk -F, '{if ($3>2 && $4>150 && $4<170) print $5}' $infile | \
