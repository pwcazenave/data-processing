...
# add in the vectors
awk -F, '{if ($3>2 && $4>55 && $4<75) print $1,$2,$4+90,0.2*(log($3)/log(10))}' $infile | grep -v NaN | \
...
awk -F, '{if ($3>2 && $4<=90 && $4>55 && $4<75) print $5; else if ($3>2 && $4>90 && $4>55 && $4<75) print $5}' $infile | grep -v NaN | \
...
#0.9 32 12 0 0 1 II
#LABEL
awk -F, '{if ($3>2 && $4<=90 && $4>55 && $4<75) print $4+90,$4+$8+90,$4-$9+90; else if ($3>2 && $4>90 && $4>55 && $4<75) print $4-90,$4+$8-90,$4-$9-90}' $infile | \
	tr " " "\n" | grep -v NaN | \
...
#155 8 12 0 0 1 III
#LABEL
awk -F, '{if ($3>2 && $4<=90 && $4>55 && $4<75) print $3; else if ($3>2 && $4>90 && $4>55 && $4<75) print $3}' $infile | grep -v NaN | \
