...
outfile=./images/$(basename ${infile%.*}_vectors_crests.ps)
...
# add in the vectors
awk -F, '{if ($3>2) print $1,$2,$4+90,0.2*(log($3)/log(10))}' $infile | \
...
#0.9 32 12 0 0 1 II
#LABEL
awk -F, '{if ($3>2 && $4<90) print $4+90,$4+90+$8,$4+90-$9; else print $4-90,$4-90+$8,$4-90-$9}' ${infile} | tr " " "\n" | \
