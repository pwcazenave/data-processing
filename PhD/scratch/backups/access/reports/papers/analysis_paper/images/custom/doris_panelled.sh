...
# Add the interp
psxy $parea $proj -O -K -W10,darkblue -M $interp >> $outfile
...
gmtset D_FORMAT=%g
gmtset LABEL_FONT_SIZE=8 ANNOT_FONT_SIZE=8 ANNOT_OFFSET_PRIMARY=0.05c
...
awk -F, '{
   ...
   -Ba45f15:,"-@+o@+":/a5f1:,"-%":WeSn -X9.2 >> $outfile
