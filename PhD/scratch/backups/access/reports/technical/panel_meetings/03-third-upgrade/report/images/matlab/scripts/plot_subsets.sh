...
hsb1(){
   ...
   makecpt -T-28/-18/0.1 -Cgray -Z > $hsbcpt1
...
hsb2(){
   ...
   makecpt -T-40/-15/0.1 -Cgray -Z > $hsbcpt2
   ...
   pstext $hsbarea2 $hsbproj2 -O -K -D0.75/-0.15 -WwhiteO0,white -N << LABEL >> $hsb2
...
mca1(){
   ...
   makecpt -T5/30/0.1 -Cgray -Z -I > $mcacpt1
...
mca2(){
   gmtset LABEL_FONT_SIZE=18 ANNOT_FONT_SIZE=18
   makecpt -T10/20/0.1 -Cgray -Z -I > $mcacpt2
   ...
   pstext $mcaarea2 $mcaproj2 -O -K -D0.75/-0.15 -WwhiteO0,white << LABEL >> $mca2
