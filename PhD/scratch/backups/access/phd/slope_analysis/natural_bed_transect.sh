#!/bin/bash
#
#  Pierre Cazenave 20/07/07; updated 06/03/08, 11/03/08, 12/03/08, 22/08/08
#
...
gridfile=./bathy/all_lines_blockmedian_1m.grd
...
mktrans()
{
   ...
   echo -n "1 "
   project -C583400/94590 -E584000/95000 -G1 -N > ./raw_data/dunes1.trk
   echo -n "2 "
   project -C583200/93900 -E584350/94700 -G1 -N > ./raw_data/dunes2.trk
   echo -n "3 "
   project -C587000/97450 -E587600/98000 -G1 -N > ./raw_data/dunes3.trk
   echo -n "4 "
   project -C586100/96100 -E586900/97000 -G1 -N > ./raw_data/dunes4.trk
   echo -n "5 "
   project -C585300/95500 -E586000/95950 -G1 -N > ./raw_data/dunes5.trk
   echo -n "6 "
   project -C583400/94390 -E584000/94800 -G1 -N > ./raw_data/dunes6.trk

   # add in the transects to pick up the noise between swaths
   echo -n "7 "
   project -C585000/96000 -E584000/98000 -G1 -N > ./raw_data/dunes7.trk
   echo -n "8 "
   project -C582100/96900 -E581600/98000 -G1 -N > ./raw_data/dunes8.trk
   echo -n "9 "
   project -C580000/92000 -E579000/94000 -G1 -N > ./raw_data/dunes9.trk
   echo -n "10 "
   project -C580500/92000 -E579500/94000 -G1 -N > ./raw_data/dunes10.trk
   echo -n "11 "
   project -C587000/94500 -E586000/96000 -G1 -N > ./raw_data/dunes11.trk
   echo -n "12 "
   project -C588000/96000 -E587300/97750 -G1 -N > ./raw_data/dunes12.trk
   echo "done."
}
